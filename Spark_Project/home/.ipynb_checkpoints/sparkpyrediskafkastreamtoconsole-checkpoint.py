...
redisStreamingDF = spark.readStream\
                   .format("kafka")\
...
redisStreamingDF = redisStreamingDF.selectExpr("cast(value as string) value")
...
zSetEntriesDecodedStreamingDF = zSetEntriesEncodedStreamingDF.withColumn("customer", unbase64(zSetEntriesEncodedStreamingDF.encodedCustomer).cast("string"))
